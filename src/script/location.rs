...
impl UiLocation {
    pub fn resolve_location(&self) -> (taffy::AlignItems, taffy::JustifyContent) {
        match self {
            ...
            UiLocation::TopLeft => {
                (taffy::AlignItems::Start, taffy::JustifyContent::Start)
            }
            UiLocation::TopRight => {
                (taffy::AlignItems::Start, taffy::JustifyContent::End)
            }

            UiLocation::Bottom => (taffy::AlignItems::End, taffy::JustifyContent::Center),
            UiLocation::BottomLeft => {
                (taffy::AlignItems::End, taffy::JustifyContent::Start)
            }
            UiLocation::BottomRight => {
                (taffy::AlignItems::End, taffy::JustifyContent::End)
            }
            ...
            UiLocation::Center => {
                (taffy::AlignItems::Center, taffy::JustifyContent::Center)
            }
        }
    }
}

import{t as T,a as _}from"../chunks/BRmKbYT_.js";import{a0 as ls,i as Q,s as z,j as F,T as os,k as ps,g as w,al as es,H as ts,l as P,m as O,q as D,a8 as cs,n as G,o as R,p as rs,aw as W,ab as K,_ as M,C as Cs,af as I,ax as As,ay as ys,aa as is,az as Bs,V as U,aA as ds,aB as hs,P as us,a4 as gs,E as fs,B as bs,F as Y,K as g,J as Z,L as u,M as S,W as Fs,I as N,aC as ms,D as vs,G as xs}from"../chunks/DFNjw4_i.js";import"../chunks/D0KubzN6.js";import{e as L,s as Ds}from"../chunks/DBoNFlRm.js";import{s as X}from"../chunks/LWKitYLE.js";import{i as J}from"../chunks/CGQy_Gbb.js";import{w as ws,o as Es}from"../chunks/CuJUsSKJ.js";import{b as ks,s as _s,a as Ss}from"../chunks/CwgHPtnS.js";function Ts(p,s){return s}function $s(p,s,n,e){for(var t=[],l=s.length,r=0;r<l;r++)ys(s[r].e,t,!0);var A=l>0&&t.length===0&&n!==null;if(A){var i=n.parentNode;is(i),i.append(n),e.clear(),m(p,s[0].prev,s[l-1].next)}Bs(t,()=>{for(var d=0;d<l;d++){var a=s[d];A||(e.delete(a.k),m(p,a.prev,a.next)),U(a.e,!A)}})}function qs(p,s,n,e,t,l=null){var r=p,A={flags:s,items:new Map,first:null};{var i=p;r=F?z(os(i)):i.appendChild(ls())}F&&ps();var d=null,a=!1,B=es(()=>{var o=n();return gs(o)?o:o==null?[]:K(o)});Q(()=>{var o=w(B),C=o.length;if(a&&C===0)return;a=C===0;let c=!1;if(F){var v=r.data===ts;v!==(C===0)&&(r=P(),z(r),O(!1),c=!0)}if(F){for(var f=null,y,h=0;h<C;h++){if(D.nodeType===8&&D.data===cs){r=D,c=!0,O(!1);break}var E=o[h],x=e(E,h);y=ss(D,A,f,null,E,x,h,t,s,n),A.items.set(x,y),f=y}C>0&&z(P())}F||zs(o,A,r,t,s,e,n),l!==null&&(C===0?d?G(d):d=R(()=>l(r)):d!==null&&rs(d,()=>{d=null})),c&&O(!0),w(B)}),F&&(r=D)}function zs(p,s,n,e,t,l,r){var A=p.length,i=s.items,d=s.first,a=d,B,o=null,C=[],c=[],v,f,y,h;for(h=0;h<A;h+=1){if(v=p[h],f=l(v,h),y=i.get(f),y===void 0){var E=a?a.e.nodes_start:n;o=ss(E,s,o,o===null?s.first:o.next,v,f,h,e,t,r),i.set(f,o),C=[],c=[],a=o.next;continue}if(y.e.f&W&&G(y.e),y!==a){if(B!==void 0&&B.has(y)){if(C.length<c.length){var x=c[0],b;o=x.prev;var j=C[0],$=C[C.length-1];for(b=0;b<C.length;b+=1)H(C[b],x,n);for(b=0;b<c.length;b+=1)B.delete(c[b]);m(s,j.prev,$.next),m(s,o,j),m(s,$,x),a=x,o=$,h-=1,C=[],c=[]}else B.delete(y),H(y,a,n),m(s,y.prev,y.next),m(s,y,o===null?s.first:o.next),m(s,o,y),o=y;continue}for(C=[],c=[];a!==null&&a.k!==f;)a.e.f&W||(B??(B=new Set)).add(a),c.push(a),a=a.next;if(a===null)continue;y=a}C.push(y),o=y,a=y.next}if(a!==null||B!==void 0){for(var q=B===void 0?[]:K(B);a!==null;)a.e.f&W||q.push(a),a=a.next;var ns=q.length;if(ns>0){var as=A===0?n:null;$s(s,q,as,i)}}M.first=s.first&&s.first.e,M.last=o&&o.e}function ss(p,s,n,e,t,l,r,A,i,d){var a=(i&ds)!==0,B=(i&hs)===0,o=a?B?Cs(t):I(t):t,C=i&As?I(r):r,c={i:C,v:o,k:l,a:null,e:null,prev:n,next:e};try{return c.e=R(()=>A(p,o,C,d),F),c.e.prev=n&&n.e,c.e.next=e&&e.e,n===null?s.first=c:(n.next=c,n.e.next=c.e),e!==null&&(e.prev=c,e.e.prev=c.e),c}finally{}}function H(p,s,n){for(var e=p.next?p.next.e.nodes_start:n,t=s?s.e.nodes_start:n,l=p.e.nodes_start;l!==e;){var r=us(l);t.before(l),l=r}}function m(p,s,n){s===null?p.first=n:(s.next=n,s.e.next=n&&n.e),n!==null&&(n.prev=s,n.e.prev=s&&s.e)}function Os(p,s,...n){var e=p,t=bs,l;Q(()=>{t!==(t=s())&&(l&&(U(l),l=null),l=R(()=>t(e,...n)))},fs),F&&(e=D)}function V(p,s,n){if(n){if(p.classList.contains(s))return;p.classList.add(s)}else{if(!p.classList.contains(s))return;p.classList.remove(s)}}const Ws=!0,Xs=Object.freeze(Object.defineProperty({__proto__:null,prerender:Ws},Symbol.toStringTag,{value:"Module"})),k=ws(!1);var Ls=T('<nav class="px-4 py-2 bg-background text-fg border-b border-fg"><div class="grid grid-cols-3 text-2xl"><div class="flex items-center justify-start space-x-4"><button class="cursor-pointer transition-colors duration-300 hover:text-primary" aria-label="sidebar button"><i class="fa-solid fa-bars"></i></button></div> <a class="text-center hover:text-primary transition-colors duration-300" href="/"><h1 class="font-bold">fum documentation</h1></a> <div class="list-none flex items-center justify-end space-x-4"><a class="text-background text-lg px-2 bg-fg hover:bg-primary transition-colors duration-300" target="_blank" aria-label="doc version"></a> <a class="hover:text-primary transition-colors duration-300" href="https://discord.gg/UfXMeyZ6Zt" target="_blank" aria-label="discord invite"><i class="fa-brands fa-discord"></i></a> <a class="hover:text-primary transition-colors duration-300" href="https://github.com/qxb3/fum" target="_blank" aria-label="github link"><i class="fa-brands fa-github"></i></a></div></div></nav>');function Rs(p,s){Y(s,!1);function n(d){d.stopPropagation(),k.update(a=>!a)}J();var e=Ls(),t=g(e),l=g(t),r=g(l);u(l);var A=S(l,4),i=g(A);X(i,"href","https://github.com/qxb3/fum/releases/tag/v1.3.0"),i.textContent="v1.3.0",Fs(4),u(A),u(t),u(e),L("click",r,n),_(p,e),Z()}var js=[{url:"/docs/getting_started",raw:`---
...
`}],Ps=T('<li><a class="hover:text-primary"> </a></li>'),Ms=T('<div class="fixed top-0 w-96 h-screen border-r border-r-fg z-50 bg-background transition-all duration-300"><div class="relative"><button class="absolute top-0 right-0 m-4 cursor-pointer text-md" aria-label="close sidebar"><i class="fa-solid fa-xmark"></i></button></div> <ul class="h-full list-none mt-4 text-xl space-y-2 px-4"></ul></div>');function Is(p,s){Y(s,!1);const[n,e]=_s(),t=()=>Ss(k,"$sideBarStore",n);let l=ms();function r(){k.set(!1)}Es(()=>{window.addEventListener("click",B=>{t()&&w(l)&&!w(l).contains(B.target)&&k.set(!1)})}),J();var A=Ms(),i=g(A),d=g(i);u(i);var a=S(i,2);qs(a,4,()=>js,Ts,(B,o)=>{var C=Ps(),c=g(C),v=g(c,!0);u(c),u(C),N(()=>{X(c,"href",o.url),Ds(v,o.title)}),L("click",c,r),_(B,C)}),u(a),u(A),ks(A,B=>vs(l,B),()=>w(l)),N(()=>{V(A,"left-0",t()),V(A,"-left-96",!t())}),L("click",d,r),_(p,A),Z(),e()}var Ns=T('<!> <div class="h-full"><!> <!></div>',1);function Js(p,s){var n=Ns(),e=xs(n);Is(e,{});var t=S(e,2),l=g(t);Rs(l,{});var r=S(l,2);Os(r,()=>s.children),u(t),_(p,n)}export{Js as component,Xs as universal};
